---
title: macOS 上で glpng をコンパイルして動かす
tags:
  - Tech
  - C
  - OpenGL
...
```makefile title="src/Makefile.LINUX" del={4-5,9} ins={6-7,10}
# (省略)...
...
```c title="src/glpng.c" del={5} ins={3}
// (省略)...
...
```c title="Example/Test.c" del={4,10} ins={5,11,15}
// (省略)...
