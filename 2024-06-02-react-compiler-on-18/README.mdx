---
title: React v18でReact Compilerを使う&一部のコンポーネントだけReact Compilerで最適化する方法
tags:
  - Tech
  - React
---
...
また、React Compilerの中身を[@yossydev](https://x.com/yossydev)、[@re*taro*](https://x.com/re_taro_)と一緒に読む動画も公開しているので、興味があればぜひご覧ください。
